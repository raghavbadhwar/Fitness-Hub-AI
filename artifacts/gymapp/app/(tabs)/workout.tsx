...
export default function WorkoutScreen() {
  ...
  const filteredExercises = useMemo(() => {
    return searchExercises(debouncedExerciseSearch, selectedMuscle === "All" ? undefined : selectedMuscle);
...
function CreateTemplateModal({
  ...
  const filteredForPicker = useMemo(() => searchExercises(debouncedExerciseSearch), [debouncedExerciseSearch]);
