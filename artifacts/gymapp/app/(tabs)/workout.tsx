...
function CreateTemplateModal({
  ...
  const [exerciseSearch, setExerciseSearch] = useState("");
  const debouncedExerciseSearchModal = useDebounce(exerciseSearch, 300);
  const [showPicker, setShowPicker] = useState(false);

  const filteredForPicker = useMemo(
    () => searchExercises(debouncedExerciseSearchModal),
    [debouncedExerciseSearchModal],
  );
...
function MemberPlanModal({
  ...
  const [saving, setSaving] = useState(false);
  const [exerciseSearch, setExerciseSearch] = useState("");
  const debouncedExerciseSearchMemberModal = useDebounce(exerciseSearch, 300);
  const [showPicker, setShowPicker] = useState(false);
  ...
  const filteredForPicker = useMemo(
    () => searchExercises(debouncedExerciseSearchMemberModal),
    [debouncedExerciseSearchMemberModal],
  );
