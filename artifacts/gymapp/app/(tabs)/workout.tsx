...
export default function WorkoutScreen() {
  ...
  const filteredExercises = useMemo(() => {
    ...
    // This prevents blocking the main thread and reduces computation while typing
  ...
  const filteredAssignableMembers = useMemo(() => {
    // ⚡ Bolt Optimization: Use debounced value for array filtering
...
function CreateTemplateModal({
  ...
  // ⚡ Bolt Optimization: Debounce picker search
