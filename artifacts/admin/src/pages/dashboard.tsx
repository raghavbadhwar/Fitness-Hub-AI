...
export default function Dashboard() {
  const { data: stats, isLoading, error } = useAdminGetDashboard({ 
  ...
  if (error) {
    return (
      <div className="p-6 bg-destructive/10 text-destructive rounded-lg border border-destructive/20">
        <h2 className="font-bold flex items-center"><TrendingUp className="mr-2" /> Error Loading Dashboard</h2>
    ...
    <div className="space-y-8">
      ...
      <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-4">
        <Card data-testid="stat-card-classes">
          ...
          <CardContent>
            <div className="text-2xl font-bold" data-testid="text-stat-classes">{stats.totalClassesThisWeek}</div>
        ...
        <Card data-testid="stat-card-enrollments">
          ...
          <CardContent>
            <div className="text-2xl font-bold" data-testid="text-stat-enrollments">{stats.totalEnrollments}</div>
        ...
        <Card data-testid="stat-card-members">
          ...
          <CardContent>
            <div className="text-2xl font-bold" data-testid="text-stat-members">{stats.totalActiveMembers}</div>
        ...
        <Card data-testid="stat-card-popular">
          ...
          <CardContent>
            <div className="text-2xl font-bold capitalize" data-testid="text-stat-popular">{stats.mostPopularCategory || 'N/A'}</div>
        ...
        <CardContent className="pl-2">
          <div className="h-[300px] w-full">
            <ResponsiveContainer width="100%" height="100%">
              <BarChart data={stats.weeklyClassCounts} margin={{ top: 10, right: 10, left: -20, bottom: 0 }}>
