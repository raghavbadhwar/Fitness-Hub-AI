  ...
  return createProxyMiddleware({
    ...
    on: {
      proxyReq: (proxyReq, req) => {
        // Cast to Request to access Express-augmented properties securely
        const expressReq = req as Request;
        // Use req.protocol which respects "trust proxy" instead of reading header directly
        const protocol = expressReq.protocol || "https";
        const host = expressReq.headers.host || "";
