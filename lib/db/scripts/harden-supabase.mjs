...
if (!rolePassword) {
  throw new Error(
    "DATABASE_APP_PASSWORD must be set before running the Supabase hardening script.",
  );
}

if (!adminUrl) {
  throw new Error(
    "DATABASE_ADMIN_URL or DATABASE_URL must be set before running the Supabase hardening script.",
  );
}
